...
content = content.replace(
  /mv\.style\.position = 'absolute';\s*mv\.style\.inset = '0';\s*mv\.style\.width = '100%';\s*mv\.style\.height = '100%';\s*mv\.style\.zIndex = '1';/,
  replacement
);

fs.writeFileSync(p, content);
console.log("Added custom zoom and fullscreen controls to the 3D viewer!");
