...
const regex = /const cats = window\.CONFIG\?\.CATEGORIES \|\| \['All'\];\n\s*row\.innerHTML = cats\.map\([\s\S]*?<\/div>\`;/;
...
const newRender = `const cats = window.CONFIG?.CATEGORIES || ['All'];
  ...
  \`<div class="inline-search-wrap" style="position: relative; flex: 1; min-width: 180px; height: 34px;">
...
console.log("Updated renderCategoryChips to preserve search text!");
